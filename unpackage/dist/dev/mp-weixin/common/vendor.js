...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"vant-uni","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 12:
/*!***********************************************************!*\
  !*** C:/Users/31984/Desktop/vant-uni - 副本/store/index.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    addToCart: function addToCart(state, obj) {
      var findResult = state.cart.find(function (x) {return x.goods_id == obj.goods_id;});
      if (!findResult) {
        state.cart.push(obj);
      } else {
    ...
    savaToStorage: function savaToStorage(state) {
      uni.setStorageSync('cart', state.cart);
    },
    addCartNum: function addCartNum(state, obj) {
      var findResult = state.cart.find(function (x) {return x.goods_id == obj.goods_id;});
      findResult.goods_count++;
      this.commit('savaToStorage');
    },
    jianCartNum: function jianCartNum(state, obj) {
      var findResult = state.cart.find(function (x) {return x.goods_id == obj.goods_id;});
      findResult.goods_count--;
      this.commit('savaToStorage');
    },
    changeChecked: function changeChecked(state, obj) {
      var findResult = state.cart.find(function (x) {return x.goods_id == obj.goods_id;});
      findResult.isShow = !obj.isShow;
      this.commit('savaToStorage');
    },
    delCartNum: function delCartNum(state, obj) {
      var arr = [];
    ...
    changeTotal: function changeTotal(state, is) {
      state.cart.forEach(function (x) {
        x.isShow = is;
      });
    },
    changeTotals: function changeTotals(state, is) {
...
/***/ 14:
/*!***************************************************************************************************************!*\
  !*** C:/Users/31984/Desktop/vant-uni - 副本/node_modules/@escook/request-miniprogram/miniprogram_dist/index.js ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 24:
/*!*****************************************************************************!*\
  !*** C:/Users/31984/Desktop/vant-uni - 副本/wxcomponents/vant/toast/toast.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _validator = __webpack_require__(/*! ../common/validator */ 25);
var defaultOptions = {
  type: 'text',
  mask: false,
  message: '',
...
/***/ 25:
/*!**********************************************************************************!*\
  !*** C:/Users/31984/Desktop/vant-uni - 副本/wxcomponents/vant/common/validator.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 5:
/*!*******************************************************!*\
  !*** C:/Users/31984/Desktop/vant-uni - 副本/pages.json ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 74:
/*!*******************************************************************************!*\
  !*** C:/Users/31984/Desktop/vant-uni - 副本/wxcomponents/vant/dialog/dialog.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
